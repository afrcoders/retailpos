...
@section('content')
<div class="fade-in">
    <h1 class="mb-4"><i class="bi bi-boxes"></i> Stock Management</h1>
    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    @forelse (\App\Models\Stock::with('item')->get() as $stock)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('stock.movements', $stock->item) }}" class="btn btn-sm btn-outline-info">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">No stock items found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
