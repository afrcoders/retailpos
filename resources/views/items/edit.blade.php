...
<div class="fade-in">
    <div class="d-flex align-items-center mb-4">
        ...
        <h1 class="mb-0 ms-3"><i class="bi bi-pencil"></i> Edit Item</h1>
    </div>
                    ...
                    <form action="{{ route('items.update', $item) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                   placeholder="Enter item name" value="{{ old('name', $item->name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror"
                                   placeholder="e.g., BAR-001-001" value="{{ old('sku', $item->sku) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="cost_price" class="form-control @error('cost_price') is-invalid @enderror"
                                       placeholder="0.00" step="0.01" value="{{ old('cost_price', $item->cost_price) }}" required>
                                @error('cost_price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Unit Price (₦) *</label>
                                <input type="number" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror"
                                       placeholder="0.00" step="0.01" value="{{ old('unit_price', $item->retail_price) }}" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="reorder_level" class="form-control @error('reorder_level') is-invalid @enderror"
                                       placeholder="Minimum stock" value="{{ old('reorder_level', $item->reorder_level) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="stock_level" class="form-control @error('stock_level') is-invalid @enderror"
                                       placeholder="0" step="1" min="0" value="{{ old('stock_level', $item->stock->quantity_on_hand ?? 0) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" rows="3" placeholder="Enter item description">{{ old('description', $item->description) }}</textarea>
                        </div>

                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="is_active" value="1" class="form-check-input"
                                       id="isActive" {{ old('is_active', $item->is_active) ? 'checked' : '' }}>
